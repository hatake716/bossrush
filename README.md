...
AudioTrackでパルス波・三角波・ノイズを合成し、剣・ナイフ・弓・炎・氷・召喚獣ごとに異なるSEを鳴らします。発射と着弾は別の音です。最大8音の同時再生と、SE中だけBGMを少し下げる処理で攻撃音を聴き取りやすくしています。右上のスイッチでBGM・SEをまとめてミュートできます。タイトルは144 BPMの新曲「九つの世界への旅立ち」。ニ長調のファンファーレから冒険の旋律へ展開する32小節のオリジナル曲です。ショップ112 BPM、エンディング78 BPMです。
