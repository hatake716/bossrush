...
| 召喚士 | 115 | 巨人を呼ぶ | 白ウサギを呼ぶ | はにわを呼ぶ | 五巨人の進軍 | 通常2体＋必殺技の巨人5体。巨人は自動攻撃、ウサギは回復、はにわは被ダメージ1回の身代わり |
...
**はにわは全レベルで最長5秒。** 出現中に召喚士がダメージを受けると、方向・範囲・通常技／必殺技を問わず、その1回分をすべて肩代わりして消滅します。被弾しなくても5秒で消滅します。同時に別の攻撃を受けた場合、その次の攻撃は通常どおり判定します。既に無敵・透明化で防いだ攻撃では消費しません。出現中に「はにわを呼ぶ」を再使用すると近接攻撃ができ、寿命は延長されません。

1.0.16で白ウサギの1回の回復量を従来の半分にしました。Lv.1で8、Lv.8で19.2、Lv.16で32回復し、2秒ごとの回復間隔・回復範囲・召喚時間は従来どおりです。[召喚の調整と検証](docs/SUMMON_BALANCE.md)。
...
Lv.1の威力は最大の25%、Lv.16では100%。いずれも直線成長です。盾の軽減率は最大75%×威力係数、魔力強化の追加倍率は最大50%×威力係数、盗賊の速度上昇は最大80%×威力係数です。これらの持続時間も直線的に増加します。はにわの身代わり回数と寿命は全レベルで1回・最長5秒です。
