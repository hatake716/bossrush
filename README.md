...
1.0.19から、スタートメニューの「ハイスコア」で過去の冒険の上位10件を閲覧できます。ゲームオーバーまたはゲームクリア時の合計スコアを記録し、スコアの高い順、同点なら新しい記録を上に並べます。職業・討伐数・結果・記録日時も表示します。新しい冒険を始めても履歴は残り、アプリ終了後も保持されます。保存はこの端末内で行います。
