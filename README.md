...
BGMはAudioTrackでリアルタイム合成する、2つのパルス波、三角波の低音、ノイズ打楽器です。各ボスの専用モチーフ・調・テンポ・展開を定義しています。戦闘曲は144〜200 BPM、商人は112 BPM、タイトルは92 BPM、エンディングは78 BPM。音量は控えめな初期設定で、画面右上からミュートできます。音楽、効果音、描画ともに外部素材のダウンロードは不要です。
...
- `Content.kt`：職業、技、アイテム、32ボス、固有曲のデータ。
...
- `Chiptune.kt`：専用メロディーの合成、AudioTrack、効果音、ライフサイクル。
